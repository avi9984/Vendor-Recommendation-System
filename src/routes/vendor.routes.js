...
import { authorizeRoles, checkVendorOwnership } from "../middlewares/authorization.middlewares.js";
...
router.put("/:id", checkVendorOwnership, validate(updateVendorSchema), vendorController.updateVendor);
